...
(function() {
    ...
    var q1 = new Question('Is JavaScript the best language?',
                         ['Yes', 'No'],
                         0
                         );

    var q2 = new Question('What is the name of your employer',
                         ['Lucia', 'Paul', 'Phil'],
                         1
                         );

    var q3 = new Question('What does best describe coding?',
                         ['Easy', 'Hard', 'Boring', 'Great'],
                         3
                         );
...
// Instantiate - new instance of the Person object
...
var john = {
    ...
    presentation: function(style, timeOfDay) {
        if (style === 'formal') {
            console.log('Good ' + timeOfDay + ', Ladies and Gentleman. I\'m a ' + this.job + ' and I\'m ' + this.age + ' years old');
